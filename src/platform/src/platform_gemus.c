 ...
 *        |___/                                 
 * 
 * @file platform_gemus.c
 * @author Logan Dihel
 * @brief Platform information for gemus
 * @details This file was modified from platform_bicopter.c
 */
